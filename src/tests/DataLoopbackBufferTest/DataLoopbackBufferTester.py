    ...
    while True:
        ...
        if (dut.io_outputs_2_ready.value & dut.io_outputs_2_valid.value) == True:
            ...
            if (dut_size != size) | (dut_element!= element) | (dut_index!=index):
                ...
                print("state_index:{} \nstate_size:{} \nstate_element:{}".format(index, size, hex(element)))
                
                print("dut output:")
                print("state_index:{} \nstate_size:{} \nstate_element:{}".format(dut_index,dut_size,hex(dut_element)) )
                print("port1,state_id:{}".format(int(dut.io_outputs_2_payload_state_id.value)))
        ...
        if (dut.io_outputs_1_ready.value & dut.io_outputs_1_valid.value) == True:
            ...
            if (dut_size != size) | (dut_element!= element) | (dut_index!=index):
                ...
                print("dut output:")
                print("state_index:{} \nstate_size:{} \nstate_element:{}".format(dut_index,dut_size,hex(dut_element)) )
                print("state_id:{}".format(int(dut.io_outputs_1_payload_state_id.value)))
                raise TestFailure("test case {} failed".format(cases_count))
        ...
        if (dut.io_outputs_0_ready.value & dut.io_outputs_0_valid.value) == True:
            ...
            if (dut_size != size) | (dut_element!= element) | (dut_index!=index):
                ...
                print("state_index:{} \nstate_size:{} \nstate_element:{}".format(dut_index,dut_size,hex(dut_element)) )
                print("state_id:{}".format(int(dut.io_outputs_0_payload_state_id.value)))
                raise TestFailure("test case {} failed".format(cases_count))
