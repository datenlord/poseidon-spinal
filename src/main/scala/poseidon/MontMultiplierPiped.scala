...
object OneBitFullAdderArray{
  def apply(g:AdderArrayConfig, input:MultiplierContext, carry:UInt,sum:UInt):Unit={
...
case class MontMultiplierConfig(modulus:BigInt, compensation:BigInt, dataWidth:Int)
