...
case class MontgomeryMult(g: MontMultConfig, ipConfig: MulIPConfig)
    extends Component {
  ...
  val adderOutput0 = StreamJoin
    ...
    .translateWith {
      ...
      payload.res := (mulRes2.res + mulRes0Queued.res)(
        g.modWidth * 2 downto g.modWidth
      )
      payload
    }
    .stage()
  ...
  io.output << adderOutput0
    .translateWith {
      ...
      val adderRes1 = adderOutput0
        .res(g.modWidth - 1 downto 0) +^ U(g.compensation, g.modWidth bits)
      payload.res := Mux(
...
object MontgomeryMultVerilog {
  def main(args: Array[String]): Unit = {
    ...
    val montConfig =
      MontMultConfig(256, 255, modulus, modInverse, compensation, false)
